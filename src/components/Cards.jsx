        ...
        <section id="produtos" className="flex flex-col">
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-row justify-evenly px-8 py-6">
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        <div className="mx-auto mt-1 w-72 h-96 bg-slate-600">
                            <img className="w-100 h-100" src={Camiseta1} alt="Camiseta de Time - Seleção"/>
                        </div>
                        <h4 className="mt-4 text-3xl text-center font-bold">Camiseta Seleção Brasileira 2022/23</h4>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Camiseta Palmeiras 2023/24</h4>
                        <span className="mx-auto font-bold text-amber-600 text-2xl mt-2">50% OFF</span>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Camiseta Barcelona 2024/25</h4>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Camiseta Real Madrid 2022/23</h4>
                        <span className="mx-auto font-bold text-amber-600 text-2xl mt-2">25% OFF</span>
                        <p className="mx-auto line-through text-xl my-3">R$ 399,90</p>
                        <p className="mx-auto text-2xl text-bold mb-4">R$ 299,90</p>
                        <button className="border-2 px-4 py-2 mb-2 rounded-xl bg-yellow-500 font-bold text-black flex mx-auto hover:bg-yellow-600 transition ease-linear delay-75">Comprar</button>
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-row justify-evenly px-8 py-6">
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Bola Futebol - Euro 2024</h4>
                        <span className="mx-auto font-bold text-amber-600 text-2xl mt-2">25% OFF</span>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Bola Futebol - Copa 2022</h4>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Bola Basquete - NBA 2024/25</h4>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Bola Volei - Mikasa 2024</h4>
                        <span className="mx-auto font-bold text-amber-600 text-2xl mt-2">20% OFF</span>
                        <p className="mx-auto line-through text-xl my-3">R$ 149,90</p>
                        <p className="mx-auto text-2xl text-bold mb-4">R$ 119,90</p>
                        <button className="border-2 px-4 py-2 mb-2 rounded-xl bg-yellow-500 font-bold text-black flex mx-auto hover:bg-yellow-600 transition ease-linear delay-75">Comprar</button>
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-row justify-evenly px-8 py-6">
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Chuteira Nike - Preta</h4>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Chuteira Nike - Verde</h4>
                        <span className="mx-auto font-bold text-amber-600 text-2xl mt-2">20% OFF</span>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Camiseta Adidas - Preta</h4>
                        <span className="mx-auto font-bold text-amber-600 text-2xl mt-2">25% OFF</span>
                        <p className="mx-auto line-through text-xl my-3">R$ 299,90</p>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Chuteira Adidas - Azul</h4>
                        <span className="mx-auto font-bold text-amber-600 text-2xl mt-2">25% OFF</span>
                        <p className="mx-auto line-through text-xl my-3">R$ 399,90</p>
                        <p className="mx-auto text-2xl text-bold mb-4">R$ 299,90</p>
                        <button className="border-2 px-4 py-2 mb-2 rounded-xl bg-yellow-500 font-bold text-black flex mx-auto hover:bg-yellow-600 transition ease-linear delay-75">Comprar</button>
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-row justify-evenly px-8 py-6">
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        <div className="mx-auto mt-1 w-72 h-72 bg-slate-600">
                            <img className="w-100 h-100" src={Tenis1} alt="Tenis Nike - Preto"/>
                        </div>
                        <h4 className="mt-4 text-3xl text-center font-bold">Tenis Nike - Preto</h4>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Tenis Adidas - Laranja</h4>
                        <span className="mx-auto font-bold text-amber-600 text-2xl mt-2">25% OFF</span>
                        <p className="mx-auto line-through text-xl my-3">R$ 299,90</p>
                        <p className="mx-auto text-2xl text-bold mb-4">R$ 224,90</p>
                        <button className="border-2 px-4 py-2 mb-2 rounded-xl bg-yellow-500 font-bold text-black flex mx-auto hover:bg-yellow-600 transition ease-linear delay-75">Comprar</button>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Tenis Puma - Preto</h4>
                        <span className="mx-auto font-bold text-amber-600 text-2xl mt-2">20% OFF</span>
                        <p className="mx-auto line-through text-xl my-3">R$ 249,90</p>
                        <p className="mx-auto text-2xl text-bold mb-4">R$ 199,90</p>
                        <button className="border-2 px-4 py-2 mb-2 rounded-xl bg-yellow-500 font-bold text-black flex mx-auto hover:bg-yellow-600 transition ease-linear delay-75">Comprar</button>
                    ...
                    <div className="flex flex-col px-3 py-4 border-2 rounded-lg max-w-80  border-yellow-400 bg-black text-white">
                        ...
                        <h4 className="mt-4 text-3xl text-center font-bold">Tenis Nike - Rosa</h4>
                        <span className="mx-auto font-bold text-amber-600 text-2xl mt-2">25% OFF</span>
                        <p className="mx-auto line-through text-xl my-3">R$ 399,90</p>
                        <p className="mx-auto text-2xl text-bold mb-4">R$ 299,90</p>
                        <button className="border-2 px-4 py-2 mb-2 rounded-xl bg-yellow-500 font-bold text-black flex mx-auto hover:bg-yellow-600 transition ease-linear delay-75">Comprar</button>
